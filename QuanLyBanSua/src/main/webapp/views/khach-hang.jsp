	...
	function xoa(makh) {
		...
		xhr.onreadystatechange = function () {
			if(this.readyState == 4 && this.status == 200) {
				...
				document.getElementById(makh).style.display = "none";
			}
	
		}
		xhr.open("get", "xoa-khach-hang?makh=" + makh);
		xhr.send();
	}
</script>
<h2 align='center'>THÔNG TIN KHÁCH HÀNG</h2>

<h3 align="center" style="color: red;"><i id="message"></i></h3>
	...
	<table class="tblkh" style="width: 100%;"border="1">
		...
		<tr id="${kh.maKhachHang }">
			...
			<td>
				<a href="javascript:xoa('${kh.maKhachHang }')">Xóa</a>
			</td>
		</tr>
		</c:forEach>
	</table>
